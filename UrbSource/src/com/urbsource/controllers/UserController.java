...
public class UserController {
	...
	/**
	 * Return current user's profile page of a user as a model and JSP view.
	 * 
	 * @param model Data model object generated by Spring
	 * @return ModelAndView object corresponding to user's profile page, to be rendered by Spring
	 * @author Mehmet Emre
	 */
	...
	/**
	 * Return a user's profile page of a user as a model and JSP view. User ID is given via URL
	 * 
	 * @param userId ID of user whose profile page is requested
	 * @param model Data model object generated by Spring
	 * @return ModelAndView object corresponding to given user's profile page, to be rendered by Spring
	 * @author Mehmet Emre
	 */
