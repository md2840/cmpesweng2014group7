    ...
    self.assignEvents = function() {
        ...
        if (grid.config.jqueryUIDraggable && !grid.config.enablePinning) {
            ...
            grid.$topPanel.on('$destroy', function() {
            	//TODO bi sıkıntı olursa buradaki null ifini sonradan ekledim.
            	if(grid.$topPanel !== null){
...
angular.module('ngGrid').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('footerTemplate.html',
    ...
    "\n" +
    "            <span class=\"ngLabel\">{{i18n.ngTotalItemsLabel}} {{maxRows()}}</span><span ng-show=\"false\" class=\"ngLabel\">({{i18n.ngShowingItemsLabel}} {{totalFilteredItemsLength()}})</span>\r" +
    "\n" +
    "        </div>\r" +
    "\n" +
