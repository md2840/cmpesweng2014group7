 ...
 /**
    ...
    .config(['$translateProvider',function($translateProvider){
        ...
        $translateProvider.translations('tr-TR',{
            ...
            DIALOGS_PLEASE_WAIT_MSG: "İşlemin tamamlanması için bekleniyor.",
            DIALOGS_PERCENT_COMPLETE: "% Tamamlandı",
            DIALOGS_NOTIFICATION: "Bilgilendirme",
            DIALOGS_NOTIFICATION_MSG: "Bilinmeyen uygulama bildirimi.",
            DIALOGS_CONFIRMATION: "Onaylama",
            DIALOGS_CONFIRMATION_MSG: "Onayınız gerekmektedir.",
            DIALOGS_OK: "Tamam",
            DIALOGS_YES: "Evet",
            DIALOGS_NO: "Hayır"
        });
